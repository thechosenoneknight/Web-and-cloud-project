<template>
  ...
  >
    ...
    <el-sub-menu v-if="this.judgeIdentity()!==0" index="2">
      ...
      <el-menu-item v-if="this.judgeIdentity()!==0" index="/stuInfo">studentInfo</el-menu-item>
      <el-menu-item v-if="this.judgeIdentity()===2" index="/dormManagerInfo">DormitoryInfo</el-menu-item>
    </el-sub-menu>
    <el-sub-menu v-if="this.judgeIdentity()!==0" index="3">
      ...
      <el-menu-item v-if="this.judgeIdentity()!==0" index="/buildingInfo">BuildingInfo</el-menu-item>
      <el-menu-item v-if="this.judgeIdentity()!==0" index="/roomInfo">RoomInfo</el-menu-item>
    </el-sub-menu>
    <el-sub-menu v-if="this.judgeIdentity()!==0" index="4">
      <template #title>
        ...
        <span>InfoManage</span>
      </template>
      <el-menu-item v-if="this.judgeIdentity()===2" index="/noticeInfo">AnnouncInfo</el-menu-item>
      <el-menu-item v-if="this.judgeIdentity()!==0" index="/repairInfo">RepairInfo</el-menu-item>
    </el-sub-menu>
    <el-sub-menu v-if="this.judgeIdentity()!==0" index="5">
      <template #title>
        ...
        <span>ApplyManage</span>
      </template>
      <el-menu-item v-if="this.judgeIdentity()!==0" index="/adjustRoomInfo">transferApply</el-menu-item>
    </el-sub-menu>
