<template>
  <div style="line-height: 50px;display: flex">
    <div style="width: 200px;margin-left: 10px; font-weight: bold; color: dodgerblue">UniversityDormitoryManagetSystem</div>
    ...
    <div class="right-info">
      <el-dropdown>
        ...
        <template #dropdown>
          <el-dropdown-menu>
            <el-dropdown-item @click="selfInfoManage">Personal Information</el-dropdown-item>
