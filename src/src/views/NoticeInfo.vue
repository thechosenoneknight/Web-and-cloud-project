<template>
  <div>
    <el-breadcrumb separator-icon="ArrowRight" style="margin: 16px">
      ...
      <el-breadcrumb-item>Announcement Information</el-breadcrumb-item>
    </el-breadcrumb>
    <el-card style="margin: 15px; min-height: calc(100vh - 111px)">
      <div>
        ...
        <el-table v-loading="loading" :data="tableData" border max-height="705" style="width: 100%">
          ...
          <el-table-column label="author" prop="author" width="150px"/>
          <el-table-column label="releaseTime" prop="releaseTime" sortable width="400px"/>
          <!--      操作栏-->
        ...
        <!--      弹窗-->
        <div>
          <el-dialog v-model="dialogVisible" title="operation" width="50%" @close="cancel">
            <el-form ref="form" :model="form" :rules="rules" label-width="120px">
              ...
              <el-form-item label="releaseTime" prop="releaseTime" style="margin-top: 27px">
                <el-date-picker
          ...
          <!--    公告详情-->
          <el-dialog v-model="detailDialog" title="detials" width="50%">
            <el-card>
              <div v-html="detail.content"></div>
            </el-card>
            <template #footer>
              <span class="dialog-footer">
                <el-button type="primary" @click="closeDetailDialog">confirm</el-button>
              </span>
            </template>
          </el-dialog>
        </div>
