<template>
  <div class="login-container">
    ...
    <div style="width: 400px; margin: 150px auto">
      <div style="color: black; font-size: 30px; text-align: left; padding: 30px 0">login</div>
      <el-form ref="form" :model="form" :rules="rules" size="large">
        ...
        <el-form-item :model="form" prop="identity">
          <el-radio v-model="form.identity" label="stu" style="color: grey">student</el-radio>
<!--          <el-radio v-model="form.identity" label="dormManager" style="color: grey">宿舍管理员</el-radio>-->
          <el-radio v-model="form.identity" label="admin" style="color: grey">system administrator</el-radio>
        </el-form-item>
        <el-form-item>
          <el-button :disabled="!disabled" style="width: 20%" type="primary" @click="login">login</el-button>
        </el-form-item>
      </el-form>
    </div>
  </div>
